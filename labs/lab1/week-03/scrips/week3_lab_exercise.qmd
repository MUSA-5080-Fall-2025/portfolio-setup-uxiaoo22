...
census_api_key(Sys.getenv("ec702835845a134b4376c60759aa72ce62f6df59."))
...
ggplot(county_data) +
  ...
  geom_boxplot(fill = "lightpink", width = 0.5) +
  labs(
    title = "Median population with Outliers",
    y = "population"
  ) +
  theme_minimal() +
...
ggplot(county_reliability) +
  aes(x = total_popE, y = income_moe_pct) +
  geom_point(alpha = 0.7) +
  geom_hline(yintercept = 10, color = "blue", linetype = "dashed",size = 2 ) +
  labs(
